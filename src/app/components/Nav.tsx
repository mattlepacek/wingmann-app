...
export default function Nav({ links }: { links: NavLink[] }) {
  ...
  return (
    <>
      ...
      {/* Mobile menu — must be outside nav to avoid backdrop-filter containing block */}
      <div
        className={`sm:hidden fixed inset-x-0 top-16 bottom-0 z-50 bg-black transition-all duration-300 ${
